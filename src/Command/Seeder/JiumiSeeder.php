...
class JiumiSeeder extends BaseCommand
{
    ...
    {
        return [
            ['module', null, InputOption::VALUE_REQUIRED, '请输入要生成的模块'],
            ['path', null, InputOption::VALUE_OPTIONAL, '应该创建模块文件的位置'],
            ['realpath', null, InputOption::VALUE_NONE, '指出任何提供的模块文件路径都是预先解析的绝对路径'],
        ];
    }
